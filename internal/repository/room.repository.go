	...
	room := &models.Project{
		...
		Config: models.Config{
			Columns: []models.Column{
				{Name: "Sistema", Visible: true},
				{Name: "Edad", Visible: true},
				{Name: "Formacion", Visible: true},
				{Name: "Miembro", Visible: true},
				{Name: "Espesor", Visible: true},
				{Name: "Litologia", Visible: true},
				{Name: "Estructura fosil", Visible: true},
				{Name: "Facie", Visible: true},
				{Name: "AmbienteDepositacional", Visible: true},
				{Name: "Descripcion", Visible: true},
			},
			IsInverted: false,
		},
	}
